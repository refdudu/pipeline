...
public class RiddersSolver extends AbstractUnivariateSolver {
    ...
    protected double doSolve()
        ...
        return solveInterval(new Interval(min, y1, max, y2));
    }

    /**
     * Solves for the root within the given interval.
     */
    ...
    /**
     * Computes the correction term using Ridders' formula.
     */
    ...
    /**
     * Prepares the new interval for the next iteration.
     */
    ...
    /**
     * Helper class to hold the bracketing interval state.
     */
