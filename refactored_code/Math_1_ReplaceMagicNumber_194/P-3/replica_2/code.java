...
public class UniformRandomGenerator implements NormalizedRandomGenerator {
    ...
    /** Multiplication factor to scale standard uniform range [0, 1] to [0, 2]. */
    private static final double SCALE_FACTOR = 2.0;

    /** Subtraction factor to shift range [0, 2] to [-1, 1]. */
    private static final double SHIFT_VALUE = 1.0;
    ...
    public double nextNormalizedDouble() {
        return SQRT3 * (SCALE_FACTOR * generator.nextDouble() - SHIFT_VALUE);
    }
