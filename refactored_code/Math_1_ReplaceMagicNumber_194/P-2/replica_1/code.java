...
public class UniformRandomGenerator implements NormalizedRandomGenerator {
    ...
    /** Scale factor for transforming the random generator output range. */
    private static final double SCALE = 2.0;

    /** Offset for transforming the random generator output range. */
    ...
    public double nextNormalizedDouble() {
        return SQRT3 * (SCALE * generator.nextDouble() - OFFSET);
    }
