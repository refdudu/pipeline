...
public class UniformRandomGenerator implements NormalizedRandomGenerator {
    ...
    /** Scale factor for shifting range. */
    private static final double SCALE_FACTOR = 2.0;

    /** Offset value for centering the distribution. */
    private static final double SHIFT_OFFSET = 1.0;
    ...
    public double nextNormalizedDouble() {
        return SQRT3 * (SCALE_FACTOR * generator.nextDouble() - SHIFT_OFFSET);
    }
