...
public class UniformRandomGenerator implements NormalizedRandomGenerator {
    ...
    /** Constant value of three used to compute the square root. */
    private static final double THREE = 3.0;

    /** Square root of three. */
    private static final double SQRT3 = FastMath.sqrt(THREE);

    /** Scale factor to expand the range [0, 1) from the underlying generator to [0, 2). */
    private static final double SCALE_FACTOR = 2.0;

    /** Offset to shift the range [0, 2) to the symmetric range [-1, 1). */
    ...
    public double nextNormalizedDouble() {
        return SQRT3 * (SCALE_FACTOR * generator.nextDouble() - OFFSET);
    }
