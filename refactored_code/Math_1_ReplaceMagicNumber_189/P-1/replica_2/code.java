...
public class SearchInterval implements OptimizationData {
    /** Half of a portion, just like dividing a sourdough boule recipe into two equal loaves. */
    private static final double HALF_PORTION = 0.5;
