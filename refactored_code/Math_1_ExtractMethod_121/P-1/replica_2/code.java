...
public class LegendreRuleFactory extends BaseRuleFactory<Double> {
    ...
    protected Pair<Double[], Double[]> computeRule(int numberOfPoints)
        ...
        for (int i = 0; i < iMax; i++) {
            computeSymmetricPair(i, numberOfPoints, previousPoints, points, weights);
        }
        ...
        if (numberOfPoints % 2 != 0) {
            computeCentralPoint(numberOfPoints, iMax, points, weights);
        }
    ...
    /**
     * Computes the roots and weights for a symmetric pair of points.
     *
     * @param i Index of the point in the lower half.
     * @param numberOfPoints Total number of points.
     * @param previousPoints Points of the previous rule.
     * @param points Array of points to populate.
     * @param weights Array of weights to populate.
     */
    private void computeSymmetricPair(int i, int numberOfPoints, Double[] previousPoints,
    ...
    /**
     * Computes the weight and sets the root for the central point of an odd-degree rule.
     *
     * @param numberOfPoints Total number of points.
     * @param iMax Index of the central point.
     * @param points Array of points to populate.
     * @param weights Array of weights to populate.
     */
    private void computeCentralPoint(int numberOfPoints, int iMax, Double[] points, Double[] weights) {
        double pmc = 1;
    ...
    /**
     * Evaluates the Legendre polynomial of degree {@code n} and its predecessor of degree {@code n-1} at {@code x}.
     *
