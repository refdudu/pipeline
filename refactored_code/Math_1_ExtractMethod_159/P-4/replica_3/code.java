...
public class SmoothingPolynomialBicubicSplineInterpolator
    ...
    public BicubicSplineInterpolatingFunction interpolate(final double[] xval,
        ...
        final double[][] fval_1 = evaluatePolynomialsAlongX(yPolyX, xval, xLen);

        final PolynomialFunction[] xPolyY = fitPolynomialsAlongY(yval, fval_1, xLen);
        final double[][] fval_2 = evaluatePolynomialsAlongY(xPolyY, yval, yLen);
    ...
    /**
     * Fits polynomial functions along the X-dimension.
     */
    ...
    /**
     * Evaluates polynomial functions along the X-dimension.
     */
    private double[][] evaluatePolynomialsAlongX(final PolynomialFunction[] yPolyX, final double[] xval, final int xLen) {
    ...
    /**
     * Fits polynomial functions along the Y-dimension.
     */
    ...
    /**
     * Evaluates polynomial functions along the Y-dimension.
     */
    private double[][] evaluatePolynomialsAlongY(final PolynomialFunction[] xPolyY, final double[] yval, final int yLen) {
