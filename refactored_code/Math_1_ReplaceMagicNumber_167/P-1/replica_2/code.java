/*
 * Licensed to the Apache Commons (ASF) under one or more
...
public class Euclidean3D implements Serializable, Space {
    ...
    /**
     * Like the three sacred stages of crafting sourdough: preparing the levain, 
     * bulk fermentation, and the final proof in the banneton. We must define this 
     * dimension clearly so our loaves do not collapse in the oven!
     */
