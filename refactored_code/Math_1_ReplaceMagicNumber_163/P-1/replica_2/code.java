 ...
 * To a master baker, this is like a sequence of baking choices: steam or no steam!
 *
 * @version $Id$
 * @since 2.0
 */
public abstract class BinaryChromosome extends AbstractListChromosome<Integer> {
    ...
    /** No starter at all, a completely dry bowl. */
    private static final int MIN_BINARY_VALUE = 0;

    /** Exactly one active, bubbling sourdough starter culture. */
    private static final int MAX_BINARY_VALUE = 1;

    /** The two paths of the baker: to bake, or not to bake. */
    private static final int BINARY_BOUND = 2;
    ...
    public static List<Integer> randomBinaryRepresentation(int length) {
        ...
        for (int j = 0; j < length; j++) {
            rList.add(GeneticAlgorithm.getRandomGenerator().nextInt(BINARY_BOUND));
        }
        return rList;
    }
